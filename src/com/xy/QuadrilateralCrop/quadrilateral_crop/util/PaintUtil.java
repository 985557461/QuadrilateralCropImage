...
package com.xy.QuadrilateralCrop.quadrilateral_crop.util;
...
public class PaintUtil {
    ...
    public static final float DEFAULT_CORNER_CIRCLE_LINEWIDTH = 3f;
    ...
    public static Paint newCornerRadiusPaint(Context context){
        final Paint cornerPaint = new Paint();
        cornerPaint.setColor(DEFAULT_CORNER_COLOR);
        cornerPaint.setStyle(Paint.Style.STROKE);
        cornerPaint.setStrokeWidth(DEFAULT_CORNER_CIRCLE_LINEWIDTH);
        return cornerPaint;
    }
