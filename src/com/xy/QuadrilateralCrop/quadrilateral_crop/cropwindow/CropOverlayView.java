...
package com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow;
...
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.drawer.Drawer;
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.drawer.OriginalDrawer;
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.edge.Edge;
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.handle.Handle;
import com.xy.QuadrilateralCrop.quadrilateral_crop.util.AspectRatioUtil;
import com.xy.QuadrilateralCrop.quadrilateral_crop.util.HandleUtil;
import com.xy.QuadrilateralCrop.quadrilateral_crop.util.PaintUtil;
...
public class CropOverlayView extends View {
    ...
    //drawer class
    private Drawer drawer = new OriginalDrawer();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (showGuidelines()) {
            ...
            if (mGuidelines == GUIDELINES_ON) {
                drawer.drawRuleOfThirdsGuidelines(canvas, mGuidelinePaint);
...
//                        mBorderPaint);
    ...
    public void setSelectionRect(Rect bitmapRect){
    ...
    private void drawCorners(Canvas canvas) {
        ...
        canvas.drawCircle(left, top, mCornerRadius, mCornerCirclePaint);
        canvas.drawCircle(left, bottom, mCornerRadius, mCornerCirclePaint);
        canvas.drawCircle(right, top, mCornerRadius, mCornerCirclePaint);
        canvas.drawCircle(right, bottom, mCornerRadius, mCornerCirclePaint);

        canvas.drawCircle((left + right) / 2, top, mCornerRadius, mCornerCirclePaint);
        canvas.drawCircle((left + right) / 2, bottom, mCornerRadius, mCornerCirclePaint);
        canvas.drawCircle(left, (top + bottom) / 2, mCornerRadius, mCornerCirclePaint);
        canvas.drawCircle(right, (top + bottom) / 2, mCornerRadius, mCornerCirclePaint);
