...
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.drawer.NewDrawer;
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.edgenew.EdgeNew;
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.handlenew.HandleNew;
import com.xy.QuadrilateralCrop.quadrilateral_crop.cropwindow.handlenew.HandleUtilNew;
 ...
 */
public class QuadrilateralCropOverlayView extends View {
    // Private Constants ///////////////////////////////////////////////////////
    ...
    public QuadrilateralCropOverlayView(Context context) {
        super(context);
        init(context);
    }

    public QuadrilateralCropOverlayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (fullWidth == 0 || fullHeight == 0) {
            ...
            fullRect.set(0, 0, fullWidth, fullHeight);
        }
        drawer.drawBackground(canvas, fullRect, mBackgroundPaint);
...
//        drawer.drawCorner(canvas, mCornerRadius, mCornerCirclePaint);
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        resetCropRect(bitmapRect);
    }

    private void resetCropRect(Rect bitmapRect) {
        // Initialize crop window to have 10% padding w/ respect to image.
        final float horizontalPadding = 0.05f * bitmapRect.width();
        final float verticalPadding = 0.05f * bitmapRect.height();
    ...
    private void init(Context context) {
        ...
        mCornerRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CORNER_RADIUS, displayMetrics);
